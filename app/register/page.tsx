...
export default function RegisterPage() {
  ...
  async function onRegisterSubmit(data: RegisterFormValues) {
    ...
    try {
      setDebugInfo("Preparing to send registration request to API...")
      ...
      setDebugInfo(`Sending registration request for: ${data.email}`)
      
      // Call our register API endpoint
      ...
      if (!response.ok) {
        setDebugInfo(`Registration failed: ${result.error || 'Unknown error'}`)
        throw new Error(result.error || "Registration failed")
      }

      setDebugInfo(`Registration successful for ${data.email}. Session created.`)
      ...
      setDebugInfo(`Cookies after registration:\n${cookies.join('\n')}`)
      
      // Delay redirect to ensure cookies are properly set
      setDebugInfo("Registration successful! Redirecting to dashboard in 2 seconds...")
    ...
    <div className="flex min-h-screen flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold">Create CAJPRO Account</h1>
          ...
          <form onSubmit={registerForm.handleSubmit(onRegisterSubmit)}>
            <CardContent className="space-y-4 pt-6">
              ...
              <CardDescription className="text-center mb-4">
                Create a new account with PostgreSQL authentication
              </CardDescription>
